...
def manual_rows_math() -> list[dict]:
    ...
    raw = [
        ...
        ("MA0809", 5, "MA0506", "", 5, 0, 0, 0),
        ("MA0707", 5, "MA0450; MA0460", "", 5, 0, 0, 0),
        ("MA0708", 5, "MA0561", "", 5, 0, 0, 0),
        ("MA0810", 5, "MA0561; MA0704", "", 5, 0, 0, 0),
