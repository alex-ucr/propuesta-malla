...
\begin{itemize}
    \item {CA-0203 Herramientas de ciencia de datos I}
...
\begin{itemize}
    \item \hyperlink{MA0781SEDPura}{MA-0781 Seminario de estudios dirigidos en matemática pura I}
    \item \hyperlink{MA0881Pura}{MA-0881 Seminario de estudios dirigidos en matemática pura II}
\end{itemize}

\subsubsection*{Énfasis en matemática aplicada}
\begin{itemize}
    \item \hyperlink{MA0781SEDAplicada}{MA-0781 Seminario de estudios dirigidos en matemática aplicada I}
    \item \hyperlink{MA0881Aplicada}{MA-0881 Seminario de estudios dirigidos en matemática aplicada II}
\end{itemize}
...
\begin{itemize}
    ...
    \item \hyperlink{MA0709}{MA-0709 Geometría algebraica I}
