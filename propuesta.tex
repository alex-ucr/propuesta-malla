...
\input{Cursos/MA0261-algebra-lineal-i-cuerpo}
\input{Cursos/MA0351-calculo-varias-variables-cuerpo}
\input{Cursos/MA0361-algebra-lineal-ii-cuerpo}
\input{Cursos/MA0341-matematica-computacional-i-cuerpo}
\input{Cursos/MA0441-matematica-computacional-ii-cuerpo}
\input{Cursos/MAxxxx-principios-analisis-i-cuerpo}
...
\subsection{Cursos obligatorios}
\input{Cursos/MA0615-ecuaciones-diferenciales-cuerpo}
\input{Cursos/MAxxxx-teoria-numeros-cuerpo}
\input{Cursos/MAxxxx-geometria-cuerpo}
\input{Cursos/MAxxxx-algebra-abstracta-i-cuerpo}
\input{Cursos/MAxxxx-algebra-abstracta-ii-cuerpo}
\input{Cursos/MA0625-analisis-real-i-cuerpo}
\input{Cursos/MAxxxx-principios-analisis-ii-cuerpo}
...
\input{Cursos/MAxxxx-topologia-cuerpo}
