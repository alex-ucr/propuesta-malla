...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0503 Estadística I}
\addcontentsline{toc}{subsection}{MA-0503 Estadística I}
...
\begin{tabular}{|ll|}
\hline
\textbf{Año:} III  & \textbf{Requisitos:} MA-0404 Herramientas de Ciencia de \\ & Datos y  MA-0421 Introducción a la Probabilidad \\ 
