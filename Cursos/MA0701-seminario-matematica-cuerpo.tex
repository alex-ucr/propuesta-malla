%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%% MA-1301 Seminario de Matemática %%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-1301 Seminario de Matemática}
\addcontentsline{toc}{subsection}{MA-1301 Seminario de Matemática}
...
\begin{enumerate}
    ...
    \item Coordinar, orientar y evaluar la discusión grupal, sintetizando los argumentos tratados y demostrando dominio de la temática matemática abordada en el semestre.
\end{enumerate}

\textbf{Sugerencias metodológicas:}

\begin{enumerate}
    \item Se sugiere que la persona coordinadora sea quien ocupe la dirección del Departamento de Matemáticas, o quien este designe.
    \item Pueden validarse charlas de ciclos especiales del departamento (por ejemplo, cátedras, semanas temáticas o invitados internacionales), siempre que se anuncien con claridad como actividades válidas para MA-1301.
...
\begin{itemize}
\item Que el Departamento de Matemáticas o la coordinación del curso la haya dispuesto expresamente como válida para MA-1301.
...
Las ausencias podrán justificarse conforme al Reglamento del Régimen Académico Estudiantil y demás normativa institucional vigente, a criterio de la coordinación del curso.
...
\end{itemize}
\item \textbf{Reprobación:} si no se completan las 10 asistencias en el plazo correspondiente, o si falta a la sesión final sin justificación válida, el curso se reportará como \textbf{No Aprobado (NAP)} y deberá matricularse nuevamente, reiniciando el conteo de asistencias desde cero.
\end{enumerate}
