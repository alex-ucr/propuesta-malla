...
\begin{tabular}{|ll|}
\hline
\textbf{Año:} IV  & \textbf{Requisitos:} Haber aprobado al menos uno de: MA-0661 \\ & Algebra Abstracta II, MA-0635 Topología General, \\ & MA-0647 Modelación Matemática o \\ &MA-0641 Análisis Numérico I \\ 
\textbf{Ciclo:} VII  & \textbf{Correquisitos:} Ninguno \\ 
\textbf{Tipo de curso:} Seminario & \textbf{Horas presenciales:} Según calendario de actividades \\ 
\textbf{Créditos:} 0 & \textbf{Horas de trabajo independiente:} 0 \\ \hline
\end{tabular}
}
\end{table}
