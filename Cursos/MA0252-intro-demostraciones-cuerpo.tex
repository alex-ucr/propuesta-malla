...
Este curso se encuentra en el II-ciclo de la carrera de Bach. y Lic. en Matemática y está dirigido al estudiantado que ha adquirido las habilidades y destrezas desarrolladas en el curso MA-XXX1 Matemática Exploratoria.

Uno de los aspectos fundamentales de este curso es que continua la transición entre la matemática a un nivel puramente operacional y la matemática más formal, la cual fue iniciada en el curso MA-XXXX Matemática Exploratoria. En particular, se da énfasis al uso correcto de las bases de la Lógica Matemática para aplicarlas en la redacción de demostraciones. 
...
\item \textbf{Lógica básica y estrategias de demostración. (3 semanas)}
...
\item \textbf{Teoría de conjuntos. (3 semanas)}
...
\item \textbf{Relaciones y funciones.(4 semanas)}
...
\item \textbf{Inducción matemática y recurrencia.(2 semanas)}
...
\item \textbf{Teoría de números.(3 semanas)}
...
\begin{enumerate}
    ...
    \item Máximo común divisor, mínimo común múltiplo y sus propiedades básicas.
