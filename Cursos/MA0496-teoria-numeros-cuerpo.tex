%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%% MA-0496 Algebra Lineal I %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0496 Teoría de Números}
\addcontentsline{toc}{subsection}{MA-0496 Teoría de Números}
...
\textbf{Año:} II  & \textbf{Requisitos:} MA-0252 Introducción a las Demostraciones  \\ 
\textbf{Ciclo:} IV  & \textbf{Correquisitos:} Ninguno \\ 
\textbf{Tipo de curso:} Teórico & \textbf{Horas presenciales por semana:} 4  \\ 
\textbf{Créditos:} 3 & \textbf{Horas de trabajo independiente por semana:} 5 \\
...
\begin{enumerate}
\item \textbf{Repaso de divisibilidad en los enteros (2 semanas):} 
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item Enunciados de teoremas básicos sobre distribución de los números primos: El Teorema de los Números Primos, las desigualdades de Chebyshev para la función $\pi(x)$, desigualdes para el $n$-ésimo número primo $p_n$, el Teorema de Dirichlet sobre primos en progresiones aritméticas.
...
\begin{enumerate}
   ...
   \item En los contenidos sobre el tema de distribución de los números primos, no se debe hacer demostraciones de aquellos resultados que están más allá del nivel de los estudiantes. Sin embargo, se espera que se discutan y se ejemplifiquen computacionalmente.
\end{enumerate}
