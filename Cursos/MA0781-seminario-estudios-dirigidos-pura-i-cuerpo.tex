%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% MA-0781 Seminario de estudios dirigidos en matemática pura I
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0781 Seminario de estudios dirigidos en matemática pura I}
\addcontentsline{toc}{subsection}{MA-0781 Seminario de estudios dirigidos en matemática pura I}

\hypertarget{MA0781SEDPura}{}
\begin{refsection}
\begin{table}[H]
\centering{
\begin{tabular}{|ll|}
\hline
\textbf{Año:} V  & \textbf{Requisitos:} MA-0781 Práctica profesional en matemática pura \\
...
Este curso de la licenciatura con \textbf{énfasis en matemática pura} ofrece un primer espacio de \textbf{estudios dirigidos} en el que la persona estudiante desarrolla, con cierta autonomía, actividades propias de la práctica investigativa en matemática, bajo la supervisión de una persona docente del Departamento de Matemáticas.
