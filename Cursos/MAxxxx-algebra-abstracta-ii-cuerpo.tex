...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-06XX Algebra Abstracta II}
\addcontentsline{toc}{subsection}{MA-06XX Algebra Abstracta II}
...
\item \textbf{Teoremas de estructura de grupos (3 semanas):} 
\begin{enumerate}
...
\item \textbf{Automorfismos (X semanas):} 
\begin{enumerate}
