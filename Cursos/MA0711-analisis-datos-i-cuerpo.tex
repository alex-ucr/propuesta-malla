...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0711 Análisis de Datos I}
\addcontentsline{toc}{subsection}{MA-0711 Análisis de Datos I}

\hypertarget{MA0711AnalisisDatos}{}
\begin{refsection}
\begin{table}[H]
\centering{
\begin{tabular}{|ll|}
