...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-01XX Introducción al Cálculo en una variable}
\addcontentsline{toc}{subsection}{MA-01XX Introducción al Cálculo}
...
\begin{enumerate}
\item \textbf{Introducción operacional a las funciones (1 semana):} 
\begin{enumerate}
...
\item \textbf{Límites y continuidad operacional (3 semanas):} 
\begin{enumerate}
...
\item \textbf{Derivación operacional (6 semanas):} 
\begin{enumerate}
...
\item \textbf{Integración de Riemann operacional (4 semanas):} 
\begin{enumerate}
