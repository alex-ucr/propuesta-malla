...
\subsection*{MA-0251 Introducción al Cálculo en una variable}
\addcontentsline{toc}{subsection}{MA-0251 Introducción al Cálculo en una variable}
\hypertarget{MA0251}{}
...
\textbf{Año:} I  & \textbf{Requisitos:} MA0151 Fundamentos de Álgebra, Trigonometría\\ &y Geometría Analítica \\ 
\textbf{Ciclo:} II  & \textbf{Correquisitos:} MA0252 Introducción a las Demostraciones \\ 
...
\item \textbf{Límites y continuidad (4 semanas):} 
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item Teorema del Valor Medio y sus aplicaciones. Monotonía y concavidad.
    \item Aproximación de una función por medio de la recta tangente. 
    ...
    \item Optimización. Puntos críticos y criterio de la segunda derivada.
\end{enumerate}

\item \textbf{Integración de Riemann (5 semanas):} 
\begin{enumerate}
    \item Notación de sumatoria y propiedades básicas de sumas finitas.
...
\begin{enumerate}
    ...
    \item Los argumentos con $\varepsilon$-$\delta$ se reservarán para  ejemplos concretos y pruebas de propiedades algebraicas básicas de límites, continuidad y derivadas.
