...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{MA-03XX Introducción al Pensamiento Algorítmico}
\addcontentsline{toc}{subsection}{MA-03XX Introducción al Pensamiento Algorítmico}
...
\textbf{Año:} II  & \textbf{Requisitos:} Calc2 + AlgLin \\ 
...
Específicamente, se retomarán contenidos de los cursos *Intro a demostraciones, cálculo y álgebra lineal*, con el fin de aplicar algoritmos básicos en la resolución de problemas, analizar su desempeño y comparar resultados teóricos con sus aproximaciones. 
...
Este curso es requisito para el curso *MA06xx Computación Científica*, en donde se continuará con el estudio y análisis matemático de algoritmos. A modo de ejemplo, en ese curso se resolverán ecuaciones diferenciales y se aplicarán resultados del álgebra lineal numérica en diferentes problemas de interés.

\subsubsection*{Objetivos}

\textbf{General:} 
Implementar el pensamiento algorítmico en la resolución de problemas matemáticos, mediante la ejecución de programas en lenguajes de programación de alto nivel. 
...
\begin{enumerate} 
    ...
    \item Aplicaciones interactivas (en \texttt{SageMath} o Geogebra).
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Se debe utilizar software libre y recursos computacionales en la nube.
