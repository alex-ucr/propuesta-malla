...
\textbf{Año:} II  & \textbf{Requisitos:} MA0252 Introducción a las Demostraciones \\ 
...
\begin{enumerate}
    ...
    \item Coordenadas y cambio de bases.
    \item Rango y nulidad de matrices, espacios de filas y de columnas.
    \item Definición y ejemplos concretos de cocientes de espacios vectoriales.
\end{enumerate}

\item \textbf{Transformaciones lineales (4 semanas):} 
\begin{enumerate}
