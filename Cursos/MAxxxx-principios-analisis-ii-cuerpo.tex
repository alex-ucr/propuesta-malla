...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-04XX Principios de análisis en varias variables}
\addcontentsline{toc}{subsection}{MA-03XX Principios de análisis en una variable}
...
\textbf{Año:} III  & \textbf{Requisitos:} MA-04XX Princ. de análisis en una variable \\ 
...
\begin{enumerate}
\item \textbf{Integración de Riemann (3 semanas):} 
\begin{enumerate}
    ...
    \item Propiedades de la integral de Riemann: linealidad, aditividad de intervalo, Teorema del Valor Medio, monotononía, etc. 
...
\item \textbf{Topología métrica de} $\mathbb{R}^n$ \textbf{(2 semanas):}
\begin{enumerate}
...
\item Conjuntos compactos, compacidad secuencial, teoremas relacionados.
\end{enumerate}
...
\begin{enumerate}
\item Definición de función diferenciable de $\mathbb{R}^n$ en $\mathbb{R}^m$.  Derivada como transformación lineal.  Matriz Jacobiana. Propiedades de la derivada: linearidad, regla del producto (escalar y vectorial).  Relación entre diferenciabilidad y continuidad.
...
\item \textbf{C\'alculo y an\'alisis vectorial (5 semanas):} 
\begin{enumerate}
...
\item Integrales de superficie: Definici\'on para superficies suaves y c\'aculo de integrales de superficies suaves por medio de parametrizaciones. 
