...
\subsection*{MA-0541 Matemática Computacional II}
\addcontentsline{toc}{subsection}{MA-0541 Matemática Computacional II}
...
\item \textbf{Integración (1.5 semana):}
...
\begin{enumerate}
	...
	\item Valores y vectores propios (Jacobi, Sturm, iteración de potencias).
	...
	\item Introducción a tópicos en análisis de datos.
\end{enumerate}
...
\item \textbf{Introducción a ecuaciones diferenciales estocásticas (1 semana):}  % computacional, pura??

\textbf{Opciones de bibliografía:} \cite{Zhang}.	
	
\begin{enumerate}
    \item Cadenas de Markov con tiempo discreto.
	\item Método de Euler–Maruyama.
	\item Método de Milstein.
	\item Métodos de Runge-Kutta.
    %\item Sistemas de ecuaciones (con dependencia).
\end{enumerate}
