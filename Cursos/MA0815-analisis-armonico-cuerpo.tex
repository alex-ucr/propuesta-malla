...
Este curso optativo introduce el análisis armónico de variable real: el estudio de la transformada de Fourier, de operadores maximales y de integrales singulares sobre $\R^n$. Se ubica en el cuarto año, una vez que la persona estudiante dispone de la medida e integración de Lebesgue y de una primera aproximación a los espacios $L^p$ (MA-0705 Análisis Real~I). Complementa la introducción a series y transformadas de Fourier que puede haberse visto en MA-0788 Análisis Real~II, y se articula de manera natural con el análisis funcional y con las ecuaciones diferenciales parciales.
