...
\textbf{General:} Desarrollar competencias de comunicación escrita y oral para transmitir ideas, resultados y argumentos matemáticos con claridad, rigor y pertinencia en contextos académicos y profesionales.
...
\item \textbf{Búsqueda bibliográfica y gestión de fuentes (1.5 semanas):}
\begin{enumerate}
...
\item \textbf{Comunicación en docencia y divulgación (1.5 semanas):}
\begin{enumerate}
...
\item \textbf{Planificación de carrera y comunicación profesional (1 semana):}
\begin{enumerate}
...
\item \textbf{Presentaciones integradoras del estudiantado (2 semanas):}
\begin{enumerate}
    \item Exposiciones finales con retroalimentación formal (rúbricas).
