...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{CA-0204 Herramientas de ciencia de datos I}
\addcontentsline{toc}{subsection}{CA-0204 Herramientas de ciencia de datos I}
...
\begin{tabular}{|ll|}
\hline
\textbf{Año:} II  & \textbf{Requisitos:} CA-0101, CI-0112 \\ 
