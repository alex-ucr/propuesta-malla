%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%% MA-03XX Algebra Lineal II %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0361 Algebra Lineal II}
\addcontentsline{toc}{subsection}{MA-0361 Algebra Lineal II}
...
\begin{enumerate}
\item \textbf{Tópicos sobre espacios y transformaciones lineales (2 semanas):} 
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item El Teorema Fundamental del Algebra y factorización de polinomios.
\end{enumerate}
...
\item \textbf{Valores y vectores propios (2 semanas):} 
\begin{enumerate}
