...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{CA-0203 Herramientas de ciencia de datos I}
\addcontentsline{toc}{subsection}{CA-0203 Herramientas de ciencia de datos I}
...
\begin{tabular}{|ll|}
\hline
\textbf{Año:} II  & \textbf{Requisitos:} MA-0341 Matemática Computacional \\ 
