...
\begin{tabular}{|ll|}
\hline
\textbf{Año:} V  & \textbf{Requisitos:} Haber aprobado el bachillerato en Matemática \\
...
Este curso de la licenciatura ofrece un segundo espacio de \textbf{estudios dirigidos} en el que la persona estudiante desarrolla, con cierta autonomía, actividades propias de la práctica investigativa en matemática, bajo la supervisión de una persona docente del Departamento de Matemáticas.
