%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%% MA-5XXX Algebra Abstracta I %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-05XX Algebra Abstracta I}
\addcontentsline{toc}{subsection}{MA-05XX Algebra Abstracta I}
...
\begin{enumerate}
\item \textbf{Definiciones, ejemplos y propiedades básicas de anillos (1.5 semanas):} 
\begin{enumerate}
...
\item \textbf{Definiciones, ejemplos y propiedades básicas de módulos (2.5 semanas):} 
\begin{enumerate}
...
\item \textbf{Módulos finitamente generados sobre dominios de ideales principales (3 semanas):} 
\begin{enumerate}
    \item Módulos libres: independencia lineal, bases, rango.
    \item Módulos finitamente presentados: módulos finitamente generados, sucesiones exactas. Anillos noetherianos y sus módulos finitamente generados.
    \item El teorema de clasificación de los módulos finitamente generados sobre dominios de ideales principales.
    \item Aplicaciones del teorema de clasificación: forma canónica de Jordan.
\end{enumerate}
...
\begin{enumerate}
    \item Aprovechar los ejemplos sobre anillos de enteros en cuerpos cuadráticos $\Q(\sqrt{d})$ que fueron estudiados en el curso MA-XXXX de Teoría de Números.
