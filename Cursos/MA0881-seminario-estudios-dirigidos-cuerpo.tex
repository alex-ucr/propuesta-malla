%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% MA-0881 Seminario de estudios dirigidos en matemática %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0881 Seminario de estudios dirigidos en matemática}
\addcontentsline{toc}{subsection}{MA-0881 Seminario de estudios dirigidos en matemática}
...
\begin{tabular}{|ll|}
\hline
\textbf{Año:} V  & \textbf{Requisitos:} MA-0781 Seminario de estudios dirigidos en matemática \\
\textbf{Ciclo:} X  & \textbf{Correquisitos:} Ninguno \\
...
Este curso de la licenciatura ofrece un segundo espacio de \textbf{estudios dirigidos} en el que la persona estudiante desarrolla, con cierta autonomía, actividades propias de la práctica investigativa en matemática, bajo la supervisión de una persona docente del Departamento de Matemáticas. Continúa la formación iniciada en MA-0781; el tema puede profundizar el del ciclo anterior o abordarse de manera independiente, según lo acordado.
...
Los contenidos \textbf{no se fijan de manera permanente} en el plan de estudios: dependen del tema y de los objetivos acordados para cada persona estudiante. Al inicio del ciclo lectivo (y, de ser posible, antes de formalizar la matrícula) deben quedar documentados por escrito:
...
\begin{enumerate}
    ...
    \item La persona docente a cargo debe ser docente o investigadora del Departamento de Matemáticas (o, con aval de la dirección del departamento, de otra unidad o institución pertinente), con formación o trayectoria adecuada al tema.
...
\begin{enumerate}
    ...
    \item Recomendar el uso de bases y repositorios matemáticos (MathSciNet, zbMATH, arXiv, repositorios institucionales) y de software libre cuando el tema lo permita.
