...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% MA-XXXX Introducción al Cálculo en Varias Variables %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{MA-02XX Introducción al Cálculo en varias variables}
\addcontentsline{toc}{subsection}{MA-02XX Introducción al Cálculo en varias variables}

\begin{refsection}
\cite{axler2011algebra}
...
\textbf{Año:} I  & \textbf{Requisitos:} MA-1XXX Introducción al Cálculo en una variable \\ 
...
Este es un curso introductorio al cálculo diferencial e integral en varias variables con un énfasis en el desarrollo de habilidades operacionales y del pensamiento intuitivo y geométrico con base en la exploración de una serie de conceptos y procedimientos propios del cálculo. Para lograr el desarrollo de estas habilidades e intuiciones, se priorizará el trabajo con ejemplos concretos.
...
\item Aplicar la definición formal de límite en la demostración de resultados básicos asociados a sucesiones y series. \cite{axler2011algebra}
\end{enumerate} 

\subsubsection*{Contenidos}

\begin{enumerate}
\item \textbf{Sucesiones y series operacional (3 semanas):} 
\begin{enumerate}
    ...
    \item Sucesiones monótonas, acotadas, aplicación del Teorema de la Convergencia Monótona.
...
\item \textbf{Sucesiones con $\varepsilon$-$N$ (1 semana):} 
\begin{enumerate}
...
\item \textbf{Series de potencias operacional (2 semanas):} 
\begin{enumerate}
    \item Definición y propiedades básicas de series de potencias.
    \item Cálculo de radio e intervalo de convergencia.
    \item Derivación e integración de una serie de potencias.
    \item Series de Taylor y funciones analíticas.
\end{enumerate}

\item \textbf{Derivación de funciones de varias variables operacional (4 semanas):} 
\begin{enumerate}
