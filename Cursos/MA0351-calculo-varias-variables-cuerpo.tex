...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{MA-0351 Cálculo en varias variables}
\addcontentsline{toc}{subsection}{MA-0351 Cálculo en varias variables}
...
\textbf{Año:} II  & \textbf{Requisitos:} MA-0251 Cálculo en una variable\\ 
\textbf{Ciclo:} III  & \textbf{Correquisitos:} MA-0361 Algebra Lineal I \\ 
