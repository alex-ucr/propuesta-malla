%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% MA-0781 Seminario de estudios dirigidos en matemática aplicada I
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0781 Seminario de estudios dirigidos en matemática aplicada I}
\addcontentsline{toc}{subsection}{MA-0781 Seminario de estudios dirigidos en matemática aplicada I}

\hypertarget{MA0781SEDAplicada}{}
\begin{refsection}
\begin{table}[H]
\centering{
\begin{tabular}{|ll|}
\hline
\textbf{Año:} V  & \textbf{Requisitos:} MA-0781 Práctica profesional en matemática aplicada \\
...
Este curso de la licenciatura con \textbf{énfasis en matemática aplicada} ofrece un primer espacio de \textbf{estudios dirigidos} en el que la persona estudiante desarrolla, con cierta autonomía, actividades propias de la práctica investigativa en matemática, bajo la supervisión de una persona docente del Departamento de Matemáticas.

A diferencia de un curso teórico con temario fijo, aquí \textbf{los objetivos se fijan de común acuerdo} entre la persona estudiante y la persona docente al inicio del ciclo lectivo, y se consignan en un plan de trabajo. El tema debe situarse en áreas de la matemática aplicada (modelación, probabilidad, estadística, análisis numérico, ciencia de datos, optimización u otras afines), ser viable en un ciclo lectivo y pertinente a la formación de la persona estudiante.
