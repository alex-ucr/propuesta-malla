...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0635 Topología General}
\addcontentsline{toc}{subsection}{MA-0635 Topología General}
...
\textbf{Año:} IV  & \textbf{Requisitos:} MA-0551 Principios de Análisis II \\ 
...
\textbf{General:} Comprender los conceptos fundamentales de los espacios métricos y de los espacios topológicos, así como las funciones continuas entre ellos, y desarrollar herramientas, tanto conjuntistas como algebraicas, para analizar y distinguir dichos espacios. \\

\textbf{Específicos:} Al finalizar el curso se espera que la persona estudiante sea capaz de:

\begin{enumerate}
\item Aplicar las definiciones y propiedades fundamentales de teoría de conjuntos, espacios métricos y espacios topológicos.


\item Aplicar conceptos de convergencia, continuidad, compacidad y funciones entre espacios para resolver problemas concretos.


\item Analizar estructuras topológicas y métricas, identificando relaciones entre propiedades como conexidad, completitud y axiomas de separación.


\item Evaluar la equivalencia entre distintas estructuras (métricas y topológicas), así como la validez de resultados mediante demostraciones rigurosas.


\item Aplicar herramientas de topología algebraica, como la homotopía y el grupo fundamental, en el estudio de propiedades globales de los espacios.


\item Sintetizar y crear argumentos matemáticos integrando los conceptos del curso para demostrar teoremas o resolver problemas avanzados.Comparar los conceptos, propiedades e implicaciones de la convergencia, continuidad, diferenciación e integración de funciones de variable real y funciones de variable compleja.
...
\item \textbf{Espacios métricos (4 semanas):} 
\begin{enumerate}
    ...
    \item Productos finitos de espacios métricos.
\end{enumerate}

\item \textbf{Espacios topológicos (4 semanas):} 
\begin{enumerate}
    \item Definiciones y propiedades básicas: Espacios topológicos, abiertos, cerrados, clausura, interior, frontera, puntos límite, subespacios.
    \item Funciones continuas y homeomorfismos.
    \item Base y subbases de una topología.
    \item Conexidad y arcoconexidad.
    \item Compacidad, espacios localmente compactos.
    \item La topología producto con finitos factores.
    \item Categoría de Baire.
\end{enumerate}

\item \textbf{Axiomas de separación (2 semanas):} 
\begin{enumerate}
    \item Axiomas de separación. Espacios T0, T1, T2.
    \item Espacios regulares y normales
    \item El lema de Urysohn.
\end{enumerate}

\item \textbf{Homotopía y el grupo fundamental (3 semanas):} 
\begin{enumerate}
    \item Homotopía de caminos.
    \item El grupo fundamental.
    \item Espacios de cobertura.
    \item Aplicaciones homotópicas.
\end{enumerate}

% \item \textbf{Tópicos adicionales (cubrir al menos uno a criterio de la persona docente)
% (1 semana):} 
% \begin{enumerate}
%     \item Retracciones y puntos fijos
%     \item Teorema de la curva de Jordan
%     \item El Teorema de Seifert-van Kampen
%     \item Clasificación de superficies
