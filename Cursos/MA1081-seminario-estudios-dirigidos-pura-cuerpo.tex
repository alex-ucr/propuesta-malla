%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% MA-1081 Seminario de estudios dirigidos en matemática pura II
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-1081 Seminario de estudios dirigidos en matemática pura II}
\addcontentsline{toc}{subsection}{MA-1081 Seminario de estudios dirigidos en matemática pura II}

\hypertarget{MA1081Pura}{}
\begin{refsection}
\begin{table}[H]
\centering{
\begin{tabular}{|ll|}
\hline
\textbf{Año:} V  & \textbf{Requisitos:} MA-0982 Seminario de estudios dirigidos en matemática pura I \\
...
Este curso de la licenciatura con \textbf{énfasis en matemática pura} ofrece un segundo espacio de \textbf{estudios dirigidos} en el que la persona estudiante desarrolla, con cierta autonomía, actividades propias de la práctica investigativa en matemática, bajo la supervisión de una persona docente del Departamento de Matemáticas. Continúa la formación iniciada en MA-0982 Seminario de estudios dirigidos en matemática pura I; el tema puede profundizar el del ciclo anterior o abordarse de manera independiente, según lo acordado.

A diferencia de un curso teórico con temario fijo, aquí \textbf{los objetivos se fijan de común acuerdo} entre la persona estudiante y la persona docente al inicio del ciclo lectivo, y se consignan en un plan de trabajo. El tema debe situarse en áreas de la matemática pura (álgebra, análisis, geometría, topología, teoría de números u otras afines), ser viable en un ciclo lectivo y pertinente a la formación de la persona estudiante.
...
\textbf{General:} Que la persona estudiante desarrolle, de manera autónoma, actividades asociadas a la investigación en matemática pura.
