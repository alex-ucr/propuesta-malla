%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%% MA-XXXX Análisis Real I %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0625 Análisis Real I}
\addcontentsline{toc}{subsection}{MA-0625 Análisis Real I}
...
\textbf{Año:} III  & \textbf{Requisitos:} MA-0515 \\ 
...
\begin{enumerate}
\item \textbf{La integral de Riemann-Stieljes (3 semanas):} 
\begin{enumerate}
...
\item \textbf{Funciones Lebesgue medibles (3 semanas):} 
\begin{enumerate}
