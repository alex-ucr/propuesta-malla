...
\begin{tabular}{|ll|}
\hline
\textbf{Año:} IV  & \textbf{Requisitos:} MA-0788 Análisis Real II \\ 
...
Se supone dominio de la medida e integración de Lebesgue en $\R^n$, espacios $L^p$ y resultados básicos de análisis real (como los desarrollados en MA-0705 Análisis Real I y MA-0788 Análisis Real II).
...
\begin{enumerate}
    \item Explicitar las conexiones entre los contenidos de MA-0705 y MA-0788 y el paso al marco abstracto.
