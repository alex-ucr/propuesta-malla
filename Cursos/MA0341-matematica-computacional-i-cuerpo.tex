%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%% MA-0341 Matemática Computacional %%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection*{MA-0341 Matemática Computacional}
\addcontentsline{toc}{subsection}{MA-0341 Matemática Computacional}
...
\textbf{Año:} II  & \textbf{Requisitos:} MA0251 Cálculo en Una Variable \\ 
\textbf{Ciclo:} III  & \textbf{Correquisitos:} MA0361 Álgebra Lineal I \\ 
...
% Ubicación en estructura curricular
...
Este curso es requisito para el curso MA-0541 Análisis Numérico I, en donde se continuará con el estudio y análisis matemático de algoritmos. A modo de ejemplo, en ese curso se resolverán ecuaciones diferenciales y se aplicarán resultados del álgebra lineal numérica en diferentes problemas de interés.
