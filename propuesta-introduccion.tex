...
En los últimos años se han realizado esfuerzos importantes para transformar las carreras que pertenecen a la Escuela de Matemática de la Universidad de Costa Rica. Un paso inicial se dio con la creación de la carrera de Educación Matemática, que, en el año 2017, abrió las puertas e integró una primera generación de estudiantes. Un año después, se consideró la necesidad de reestructurar las carreras de Matemática y Ciencias Actuariales, para lo cual se inició un proceso de manera conjunta. En el año 2019 se hizo la separación de los procesos con el fin de que se pudieran desarrollar los apartados necesarios para la construcción del perfil de cada carrera por separado. Este documento constituye una nueva propuesta para el plan de estudios de la carrera de Matemática.

El proceso ha tomado varios años. En el periodo 2018-2020, se propuso un camino que estuvo mediado por una subcomisión de la Comisión de Docencia de la Escuela de Matemática, en el que se incorporaron las apreciaciones de docentes y estudiantes, así como una revisión de las prácticas llevadas a cabo en las últimas décadas. Esto permitió llegar a establecer el perfil de egreso de lo que consideramos será un matemático del siglo XXI \footfullcite{Comision20}. Tal documento se encuentra incluido en el presente trabajo.
...
El proceso llevó a la conclusión de la importancia de incorporar dos énfasis en la carrera: el énfasis en matemática pura, un camino más teórico, orientado a formar investigadores en áreas fundamentales de la matemática, y el énfasis en matemática aplicada, dedicado también a formar investigadores, pero abierto además a la formación de profesionales que puedan desenvolverse en entornos institucionales no académicos o empresariales.
...
A partir del año 2020 se cambió la conformación de la comisión y también su dinámica. Esta etapa se caracterizó por una búsqueda de retroalimentación entre el profesorado sobre las distintas propuestas consideradas para el plan de estudios, siempre con base en el perfil de egreso ya aprobado. Se realizaron múltiples reuniones y se buscó el criterio del personal académico a través de comunicados y formularios en línea.

Con la llegada del Dr. Pedro Méndez a la dirección de la Escuela de Matemática en el año 2025 de nuevo hubo cambios en la conformación de la comisión que inició labores en 2026. Se ha buscado consolidar las observaciones recolectadas en etapas previas para así presentar una propuesta congruente con las expectativas de las personas involucradas.
...
La comisión de estructura curricular, en todas sus conformaciones históricas, se ha reunido constantemente en todo el periodo con el fin de mantener un foro de discusión que permitiera avances en un entorno pequeño. Estos avances se comunicaron al resto del personal en reuniones ampliadas con el departamento, estudiantes, etc.
...
Los procesos de entrevista individual se retomaron en 2026, con el fin de obtener retroalimentación sobre el borrador de la propuesta por parte de expertos en cada una de las principales áreas de conocimiento.
...
\subsubsection{Reuniones de departamento}
En años recientes se realizaron también reuniones con el personal del Departamento de Matemática con el objetivo de lograr retroalimentación sobre el borrador de propuesta. A diferencia de los talleres, estas reuniones tuvieron un formato de presentación seguida de espacio para comentarios de parte del profesorado.

\subsubsection{Reuniones con estudiantes}
En 2026 se realizó una reunión con estudiantes de la carrera de Matemática. Al igual que en las reuniones de departamento, el espacio se usó para presentar el borrador de la propuesta y obtener retroalimentación del estudiantado. Asimismo se escucharon las preocupaciones de las personas estudiantes sobre la etapa de transición.
...
Más recientemente, la comisión empleó los formularios electrónicos en la nube para consultar sobre aspectos particulares de la propuesta y así obtener retroalimentación sobre la estructura de cursos, contenidos, enfoque pedagógico, etc.
