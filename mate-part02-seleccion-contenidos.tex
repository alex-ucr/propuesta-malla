...
\begin{itemize}
    ...
    \item MA-0881 Práctica profesional en matemática pura (6 créditos, ciclo VIII).
    \item OPT-001 Optativa en matemática pura (4 créditos, ciclo IX)
    \item MA-0982 Seminario de estudios dirigidos en matemática pura I (7 créditos, ciclo IX).
    \item MA-1081 Seminario de estudios dirigidos en matemática pura II (7 créditos, ciclo X).
\end{itemize}
...
\begin{itemize}
    ...
    \item MA-0883 Práctica profesional en matemática aplicada (6 créditos, ciclo VIII).
    \item OPT-002 Optativa en matemática aplicada (4 créditos, ciclo IX)
    \item MA-0984 Seminario de estudios dirigidos en matemática aplicada I (7 créditos, ciclo IX).
    \item MA-1082 Seminario de estudios dirigidos en matemática aplicada II (7 créditos, ciclo X).
\end{itemize}
