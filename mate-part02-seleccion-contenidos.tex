...
Como parte del proceso de desarrollo de la estructura curricular, se agregaron los siguientes saberes, que forman parte integral de la formación de todas las personas estudiantes de la UCR.

\begin{table}[H]
\begin{center}
\begin{tabular}{|llll|}
\hline
\multicolumn{4}{|c|}{\cellcolor[HTML]{00C0F3} \textbf{Saberes humanísticos y socioculturales}} \\ \hline
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{\cellcolor[HTML]{8ED8F8}} & \multicolumn{1}{l|}{\cellcolor[HTML]{8ED8F8}} & \cellcolor[HTML]{8ED8F8} \\
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{\multirow{-2}{*}{\cellcolor[HTML]{8ED8F8} \textbf{Año}}} & \multicolumn{1}{l|}{\multirow{-2}{*}{\cellcolor[HTML]{8ED8F8} \textbf{Dominio}}} & \multirow{-2}{*}{\cellcolor[HTML]{8ED8F8} \textbf{Contenidos}} \\ \cline{2-4} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &  \\
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{\multirow{-2}{*}{I}} & \multicolumn{1}{l|}{\multirow{-2}{*}{Medio}} & \multirow{-2}{*}{Medio} \\ \cline{2-4} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &  \\
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{\multirow{-2}{*}{II}} & \multicolumn{1}{l|}{\multirow{-2}{*}{Medio}} & \multirow{-2}{*}{Medio} \\ \cline{2-4} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &  \\
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{\multirow{-2}{*}{III}} & \multicolumn{1}{l|}{\multirow{-2}{*}{Medio}} & \multirow{-2}{*}{Medio} \\ \cline{2-4} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &  \\
\multicolumn{1}{|l|}{\multirow{-10}{*}{\begin{tabular}[c]{@{}l@{}}Busca complementar la formación disciplinar del profesional\\ en matemática con una base humanística, ética y \\comunicativa. Incluye los cursos institucionales de \\ Humanidades y Repertorio (Estudios Generales), \\así como los cursos de idioma, y busca desarrollar en el \\estudiantado la capacidad de pensamiento crítico y reflexivo, \\la sensibilidad ética y estética, y las destrezas de comunicación \\oral y escrita necesarias para expresar con claridad y rigor \\tanto ideas matemáticas como argumentos propios de un \\profesional universitario comprometido con el bien común. \end{tabular}}} & \multicolumn{1}{l|}{\multirow{-2}{*}{IV}} & \multicolumn{1}{l|}{\multirow{-2}{*}{Medio}} & \multirow{-2}{*}{Medio} \\ \hline
\end{tabular}
\end{center}
\end{table}
...
\section{Justificaciones específicas de cambios}


\subsection{Análisis del plan de estudios vigente}
...
En la Tabla 2 se observa que las áreas de Análisis, Álgebra y Geometría presentan un mayor porcentaje, lo cual es acorde con las bases requeridas para toda persona profesional en matemática. De las diez identidades que se incluyen en el documento, modelación matemática y probabilidad no tienen creditaje dentro del bloque de cursos obligatorios. Estos 77 créditos obligatorios no permiten tener una flexibilidad curricular.**

Además, según el perfil de egreso aprobado en el 2020, existen prácticas emergentes tales como la investigación fuera de la academia en disciplinas afines (finanzas, banca, economía, estadística, entre otras), ciencia de datos y experimentación científica apoyada en la tecnología. Si bien es cierto la investigación académica y docencia universitaria son prácticas dominantes, la modelación matemática de fenómenos de otras disciplinas y el trabajo interdisciplinario son áreas de la matemática aplicada que han ido ganando interés y se han desarrollado para contribuir a la resolución de problemas aplicados, lo cual permite diversificar las áreas de acción de una persona matemática. Se concluyó así en el perfil de
egreso que “hay necesidad de dar respuesta a las demandas actuales de una sociedad que requiere profesionales en matemática que no solo estén presentes en un entorno académico, sino también en los entornos productivos de la industria y el comercio” (p.32).
...
\subsection{Pertinencia de un bloque común en el plan de estudios}
...
\subsection{Justificación de la creación de énfasis}

Como se mencionó anteriormente, si bien tradicionalmente la carrera de Matemática obedecía a un mercado laboral principalmente académico, en la última década, la experiencia de los graduados ha cambiado y cada vez son más los que trabajan en empresas o instituciones realizando tareas que corresponden a ámbitos más aplicados de la matemáticas (en comparación con su formación actual).

Por tal razón se propone hacer una distinción entre los énfasis en Matemática Pura y Matemática Aplicada. Esto obedece al reconocimiento de que, si bien ambas orientaciones comparten un núcleo común de formación matemática rigurosa, las trayectorias profesionales, los intereses vocacionales y las competencias específicas que demanda cada una difieren de manera sustancial. Mantener un plan único e indiferenciado obligaría a diluir la profundidad que requiere tanto la formación teórico-abstracta orientada a la investigación fundamental como la formación en modelación, cómputo y aplicación orientada a la resolución de problemas del entorno productivo, en detrimento de ambas. La separación en dos énfasis permite, en cambio, que cada estudiante profundice de manera coherente en la línea que mejor se ajusta a su vocación e intereses, sin sacrificar la calidad ni la pertinencia de la formación recibida, a la vez que preserva la unidad disciplinar y el sello institucional de la carrera mediante un tronco común compartido. 

De esta forma, la estructura por énfasis responde con flexibilidad a la diversidad de propósitos formativos establecidos para la carrera —la investigación teórica y aplicada, el impacto en el entorno productivo, y el compromiso con el bien común—, permitiendo que la persona graduada elija el camino mediante el cual materializa esos propósitos, sin que ello implique renunciar a ninguno de ellos como proyecto formativo global de la unidad académica.

En cuando a la justificación de los énfasis particulares que se están proponiendo, tenemos:

\paragraph{Énfasis en Matemática Pura:}

La creación de un énfasis en Matemática Pura responde a la tradicional necesidad de formar profesionales con una comprensión profunda y rigurosa de las estructuras abstractas que constituyen el fundamento de la disciplina, capaces de desarrollar y validar teoría matemática original más allá de su aplicación inmediata. Hoy, como hace siglos, esta sigue siendo una necesidad fundamental en las sociedades desarrolladas.

Este énfasis fortalece la vocación investigativa del programa, al brindar al estudiantado las herramientas conceptuales y el entrenamiento en demostración, axiomatización y generalización necesarios para insertarse en la comunidad matemática internacional, continuar estudios de posgrado en áreas como álgebra, análisis, topología, teoría de números u otras áreas, y contribuir a la producción de conocimiento matemático básico que, con el tiempo, suele convertirse en la base de futuras aplicaciones tecnológicas y científicas. Además, sostener este énfasis permite a la Universidad de Costa Rica cumplir con su compromiso institucional de promover la investigación fundamental y preservar espacios académicos donde el conocimiento se cultive por su valor intrínseco, sin subordinarlo exclusivamente a una utilidad inmediata.

\paragraph{Énfasis en Matemática Aplicada:}

Por su parte, el énfasis en Matemática Aplicada se justifica por la creciente y sostenida demanda, tanto del sector público como del privado, de profesionales capaces de utilizar el conocimiento matemático para modelar, analizar y resolver problemas concretos en áreas como la ciencia de datos, la optimización, las finanzas, la biología matemática o las ciencias de la computación. 

Este énfasis responde directamente al propósito de formar una persona profesional que impacte positivamente \textit{de forma directa} el entorno productivo del país, al dotarla de competencias en modelación matemática, métodos numéricos, computación científica y estadística que le permiten trabajar de manera interdisciplinaria junto a especialistas de otras áreas en la búsqueda de soluciones a problemas reales. Ofrecer esta ruta de formación amplía además las opciones de inserción laboral de las personas graduadas y fortalece los vínculos de la Escuela con otros sectores de la sociedad, consolidando el papel de la matemática como una disciplina al servicio del desarrollo social, económico y tecnológico del país.

\subsubsection{Cursos diferenciados en los énfasis}

Los ciclos I a III constituyen el bloque común y son idénticos en ambos énfasis; la diferenciación comienza a partir del ciclo IV. Se entiende por \emph{créditos diferenciados} aquellos asociados a cursos u optativas de núcleo que una persona estudiante cursa en un énfasis y que no forman parte del plan del otro (las optativas generales OPT-003 y las optativas de otra disciplina se comparten entre énfasis y no se contabilizan como diferenciadas). Observe que los bloques optativos OPT-001 y OPT-002 no comparten cursos.

En el énfasis en \textbf{Matemática Pura}, los cursos obligatorios que no se comparten con el énfasis aplicado son:
\begin{itemize}
    \item MA-0471 Introducción a la Geometría Diferencial (3 créditos, ciclo IV).
    \item MA-0496 Teoría de Números (3 créditos, ciclo IV).
    \item MA-0561 Álgebra Abstracta I (4 créditos, ciclo V).
    \item MA-0661 Álgebra Abstracta II (5 créditos, ciclo VI).
    \item OPT-001 Optativa en matemática pura (4 créditos, ciclo VII)
    \item OPT-001 Optativa en matemática pura (8 créditos, ciclo VIII)
    \item MA-0781 Práctica profesional en matemática pura (6 créditos, ciclo VIII).
    \item OPT-001 Optativa en matemática pura (4 créditos, ciclo IX)
    \item MA-0782 Seminario de estudios dirigidos en matemática pura I (7 créditos, ciclo IX).
    \item MA-0881 Seminario de estudios dirigidos en matemática pura II (7 créditos, ciclo X).
\end{itemize}
%Además, este énfasis incluye \textbf{16 créditos} en optativas del núcleo en matemática pura (OPT-001), distribuidos en los ciclos VII, VIII y IX, con un catálogo propio que no coincide con el del énfasis aplicado.

En el énfasis en \textbf{Matemática Aplicada}, los cursos obligatorios que no se comparten con el énfasis puro son:
\begin{itemize}
    \item CA-0721 Probabilidad (4 créditos, ciclo IV).
    \item CA-0203 Herramientas de ciencia de datos I (4 créditos, ciclo IV).
    \item CA-0303 Estadística Actuarial I (4 créditos, ciclo V).
    \item MA-0647 Modelación Matemática (4 créditos, ciclo VI).
    \item CA-0411 Análisis de Datos I (4 créditos, ciclo VII).
    \item OPT-002 Optativa en matemática aplicada (8 créditos, ciclo VIII)
    \item MA-0783 Práctica profesional en matemática aplicada (6 créditos, ciclo VIII).
    \item OPT-002 Optativa en matemática aplicada (4 créditos, ciclo IX)
    \item MA-0784 Seminario de estudios dirigidos en matemática aplicada I (7 créditos, ciclo IX).
    \item MA-0882 Seminario de estudios dirigidos en matemática aplicada II (7 créditos, ciclo X).
\end{itemize}
%Además, este énfasis incluye \textbf{12 créditos} en optativas del núcleo en matemática aplicada (OPT-002), en los ciclos VIII y IX, con catálogo distinto al OPT-001.

De esta manera, el número total de créditos por ciclo y de créditos diferenciados de cada énfasis se resume en la Tabla~\ref{tab:creditos-diferenciados-enfasis}, junto con el porcentaje de diferenciación sobre el total de créditos del plan de bachillerato y de licenciatura. La normativa vigente exige que la diferenciación se sitúe entre el 25\% y el 40\%; la propuesta cumple ese rango en ambos énfasis y en ambos títulos.
...
\hline
\rowcolor[HTML]{00C0F3}
\textbf{Ciclo} & \textbf{Créditos Pura} & \textbf{Créditos Aplicada} & \textbf{Dif.\ Pura} & \textbf{Dif.\ Aplicada} \\
\hline
I & 15 & 15 & 0 & 0 \\
II & 18 & 18 & 0 & 0 \\
III & 17 & 17 & 0 & 0 \\
...
VIII & 18 & 18 & 14 & 14 \\
\hline
\textbf{Total bachillerato} & \textbf{130} & \textbf{131} & \textbf{33} & \textbf{34} \\
\hline
\textbf{Porcentaje bachillerato} & 100{,}00\% & 100{,}00\% & 25{,}38\% & 25{,}95\% \\
\hline
IX & 15 & 15 & 11 & 11 \\
X & 15 & 15 & 7 & 7 \\
\hline
\textbf{Total licenciatura} & \textbf{291} & \textbf{293} & \textbf{84} & \textbf{86} \\
\hline
\textbf{Porcentaje licenciatura} & 100{,}00\% & 100{,}00\% & 28{,}87\% & 29{,}35\% \\
\hline
\end{tabular}
\caption{Créditos totales por ciclo y créditos diferenciados en los planes propuestos.}
\label{tab:creditos-diferenciados-enfasis}
