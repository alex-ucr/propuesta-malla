...
\begin{itemize}
    ...
    \item OPT-002 Optativa en matemática pura (4 créditos, ciclo VII)
    \item OPT-002 Optativa en matemática pura (8 créditos, ciclo VIII)
    ...
    \item MA-0781 Seminario de estudios dirigidos en matemática pura I (7 créditos, ciclo IX).
...
\begin{itemize}
    ...
    \item MA-0781 Práctica profesional en matemática aplicada (6 créditos, ciclo VIII).
    \item OPT-002 Optativa en matemática aplicada (4 créditos, ciclo IX)
    \item MA-0781 Seminario de estudios dirigidos en matemática aplicada I (7 créditos, ciclo IX).
    \item MA-0881 Seminario de estudios dirigidos en matemática aplicada II (7 créditos, ciclo X).
\end{itemize}
