...
En el programa del énfasis en Matemática Pura, los siguientes cursos son específicos para esa rama:
\begin{itemize}
    \item MA0496 Teoría de Números. 3 créditos.
\end{itemize}

En el programa del énfasis en Matemática Pura, los siguientes cursos son específicos para esa rama:
\begin{itemize}
    \item CA0203 Herramientas de ciencia de datos. 4 créditos.
\end{itemize}

De esta manera, el número total de créditos diferenciados de cada énfasis se muestra en la tabla, así como su porcentaje del total.
