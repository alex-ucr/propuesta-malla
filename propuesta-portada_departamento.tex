  ...
  \node[anchor=north west, inner sep=0pt]
    at ([xshift=2.15cm, yshift=-4.15cm]current page.north west) {
      \begin{minipage}{12.4cm}
        ...
        {\color{red}\fontsize{12}{14}\selectfont\bfseries DOCUMENTO CONDENSADO \par}
        \vspace{10pt}
        ...
        de modificación curricular)\par}
      \end{minipage}
    };
  ...
  \node[anchor=south west, inner sep=0pt]
    at ([xshift=2.15cm, yshift=2.35cm]current page.south west) {
      \begin{minipage}{10cm}
        ...
        {\fontsize{12}{15}\selectfont Comisión de Estructura Curricular\par}
