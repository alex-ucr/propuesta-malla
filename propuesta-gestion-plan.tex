...
En este apartado se plantean componentes necesarios para la administración educativa de la estructura curricular, incluyendo el plan de transición para estudiantes activos del plan de estudios vigente. También se aborda la evaluación curricular posterior a su futura implementación y la forma en que el personal docente será capacitado para las nuevas exigencias de la estructura curricular.
...
\MA{0788} & \gls{MA0788} & Análisis &  \\ \hline
...
Para estudiantes activos que ingresaron en el año 2025 o anteriores, se propone un plan de transición con base en la cohorte que corresponda, bajo el supuesto de que cada estudiante tiene el año correspondiente a la cohorte completa al finalizar el año 2025. Los documentos completos se incluyen en el Anexo ??.
...
I29 & \begin{tabular}[c]{@{}l@{}}\textbf{Pura:} igual que el ciclo VII del plan 03\\ \textbf{Aplicada:}\\ CA0303 Estadística Actuarial I (4)\\ MA0702 Análisis Complejo (4)\\ MA0705 Análisis Real I (5)\\ MA0880 Comunicación en las Ciencias (2)\end{tabular} \\ \hline
II29 & \begin{tabular}[c]{@{}l@{}}\textbf{Pura:} igual que el ciclo VIII del plan 03\\ \textbf{Aplicada:}\\ CA0411 Análisis de Datos I (4)\\ Optativa específica de matemática (4)\\ Optativa específica de matemática (4)\\ MA0883 Práctica profesional en matemática aplicada (4)\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
Cada estudiante que no haya cumplido sus ciclos de estudio de acuerdo con el plan de estudios anterior, no contemplados en los incisos anteriores, o aquellos de planes previos, deberá utilizar la tabla de convalidaciones para trasladarse hacia la estructura del nuevo plan de estudios, y deberá cursar los cursos no convalidables hasta cumplir con todos los requisitos del plan 2028. 

\subsubsection{Convalidaciones}

Se plantea considerar convalidaciones para casos particulares que no cumplen con una cohorte específica; ver Tabla \ref{tab:conv}. De esta forma, se deberán trasladar al Plan 03 que inicia en el 2028, realizando las convalidaciones que correspondan, y deberán cursar aquellos cursos no convalidables hasta cumplir con todos los requisitos del plan 2028.
...
MA0605 Análisis II & MA0788 Análisis Real II \\ \hline
...
II & C6P & MA0661 Álgebra Abstracta II & 5 & 1 & 0.375 \\ \hline
...
I & C6P C6A & MA0705 Análisis Real I & 5 & 1 & 0.375 \\ \hline
I & C6P C6A & MA0880 Comunicación en las Ciencias & 2 & 1 & 0.375 \\ \hline
...
II & C7P & MA0661 Álgebra Abstracta II & 5 & 1 & 0.375 \\ \hline
II & C6P & MA0881 Práctica profesional en matemática pura & 4 & 1 & 0.000 \\ \hline
II & C6A & MA0883 Práctica profesional en matemática aplicada & 4 & 1 & 0.000 \\ \hline
...
I & C7P C7A & MA0705 Análisis Real I & 5 & 1 & 0.375 \\ \hline
I & C7P C7A & MA0880 Comunicación en las Ciencias & 2 & 1 & 0.375 \\ \hline
...
II & C8P & MA0661 Álgebra Abstracta II & 5 & 1 & 0.375 \\ \hline
II & C7P & MA0881 Práctica profesional en matemática pura & 4 & 1 & 0.375 \\ \hline
II & C7A & MA0883 Práctica profesional en matemática aplicada & 4 & 1 & 0.375 \\ \hline
...
I & C8P C8A & MA0705 Análisis Real I & 5 & 1 & 0.375 \\ \hline
I & C8P C8A & MA0880 Comunicación en las Ciencias & 2 & 1 & 0.375 \\ \hline
...
II & C9P & MA0661 Álgebra Abstracta II & 5 & 1 & 0.375 \\ \hline
II & C8P & MA0881 Práctica profesional en matemática pura & 4 & 1 & 0.375 \\ \hline
II & C8A & MA0883 Práctica profesional en matemática aplicada & 4 & 1 & 0.375 \\ \hline
...
\caption{Resumen de la proyección de carga académica, 2028--2031 [NO ESTÁ ACTUALIZADA]}
...
En esta sección se plantea la estrategia de evaluación de la carrera y el plan de desarrollo docente que la Escuela de Matemática podría implementar para capacitar al cuerpo docente ante las nuevas exigencias académicas de la estructura propuesta.
...
Por otro lado, se recomienda que el Departamento nombre una comisión encargada de la evaluación de la estructura curricular propuesta para que tenga listo un diagnóstico del perfil de egreso y de la estructura vigente a lo sumo cinco años después de que el plan se haya incorporado de manera completa en la población estudiantil. Se recomienda que los mismos miembros que conformaron la elaboración de este documento participen en esa comisión de evaluación.
