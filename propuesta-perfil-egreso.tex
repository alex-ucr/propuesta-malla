...
Durante las dos primeras décadas del siglo XXI, el desarrollo de la matemática está en constante aumento gracias a la digitalización de la mayor parte de los objetos usados en el siglo pasado (fotografía, música, medicina, documentos, etc.) y su transferencia.  El célebre matemático Cédric Villani, a quien se le otorgó la medalla Fields, en el año 2010, mencionó en una conferencia en la Facultad de Ciencias de la Universidad Nacional Autónoma de México, que la cantidad de estudiantes de matemática ha aumentado más del 20\% en los últimos 20 años, y esto se debe principalmente a la digitalización del mundo \cite{Villani2020}. 

    La Organización de las Naciones Unidas para la Educación, la Ciencia y la Cultura (UNESCO, por sus siglas en inglés) menciona \cite{UNESCO2020math} el importante desarrollo de la matemática a través del mundo, y, sobre todo, en los países en vías de desarrollo:
...
Debido a la importancia de las matemáticas y su interacción con otras áreas, es que la cuadragésima Conferencia General de la UNESCO, en noviembre de 2019, proclamó el 14 de marzo de cada año como el Día Internacional de las Matemáticas, y la siguiente cita figura en su página web \cite{UNESCO2020IDM}: 
 ...
 Considerando lo expuesto por la UNESCO en la cuadragésima conferencia, la temática de 2020, primer año de la conmemoración, fue: Las matemáticas están en todas partes. En \cite{UNESCO2020IDM} se lee:
...
Y la importancia de la matemática en varias áreas y actividades de la humanidad se ve en la ciencia y la tecnología, cuyos ejemplos son variados, según \cite{UNESCO2020IDM}:
...
tal y como se presenta en \cite{UNESCO2020IDM}:
...
La organización de las Naciones Unidas, a través de la UNESCO, menciona que las matemáticas son esenciales para alcanzar los Objetivos de Desarrollo Sostenible de la ONU, y en alusión a esto, mencionan en \cite{UNESCO2020IDM} los siguientes ejemplos: 
...
\begin{itemize}
    ...
    \color{blue} \item \color{black} La cultura científica y matemática ayuda a cada ciudadano a comprender mejor los desafíos que le rodean. 
     ...
     \color{blue} \item \color{black} Finalmente, en esta mención \cite{UNESCO2020IDM} de lo que expresa la UNESCO en relación con las matemáticas, se manifiesta que están en todas partes y en todo lo que hacemos: 
    ...
    \color{blue} \item \color{black} Prácticamente todo el mundo usa algunos conceptos matemáticos: el constructor, el granjero, el comerciante, el artesano, el atleta, \ldots
...
Todo esto nos muestra que la matemática ha sido usada a lo largo de la historia de la civilización en diferentes circunstancias. Cabe preguntarnos algunas de las siguientes proezas, tal y como se lo preguntan en \cite{ReasonsMath2020}: 
...
en \cite{ReasonsMath2020} la siguiente cita:
...
Según el ranking de 2016 de CareerCast.com de los 200 mejores empleos, las carreras relacionadas con la matemática ocuparon posiciones destacadas. Por ejemplo: en primer lugar, analista de datos; en segundo, estadístico; en sexto, matemático; y en décimo, actuario. Otras carreras con alto contenido matemático quedaron en las siguientes posiciones: ciencias de la computación (\# 7), ingeniería biomecánica (\# 14), meteorología (\# 16), física (\# 21), economía (\# 24), analistas financieros (\# 27), ingeniería ambiental (\# 37), ingeniería civil (\# 38), ingeniería mecánica (\# 58) e ingeniería aeroespacial (\# 59). 

Además, la Oficina de Trabajo Estadístico (Bureau of Labor Statistics) proyectó un crecimiento del 28\,\% en empleos de ocupaciones matemáticas entre 2016 y 2026, superior al promedio de todos los demás empleos. Esa proyección se asoció con el auge del \emph{big data}. 
